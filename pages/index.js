...
export default function Home() {
  ...
  return (
    <div className="bg-gray-300 h-full flex flex-col relative overflow-x-hidden">
      <Head>
      ...
      />
      {open ? (
        <Vods followerData={followerData} open={open} setOpen={setOpen} currentFollower={currentFollower}
